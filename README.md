...
${\color{red}Note}$: We provided a cleaner and complete implementation [here](https://github.com/zhenjia2017/EXAQTV2). Hope it helps you to reproduce the paper results. It also can be used for evaluating other KGQA benchmarks.

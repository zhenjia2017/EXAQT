...
class QuestionUnionGST():
    ...
    def complete_GST(self, spo_file, GST_file, GST_entities, union_predicates, union_cornerpredicates):
        gstspo = []
        spolines = []
        state = {}
        uniongstspolines = []
    ...
    def get_QKG_GST_from_spo(self, id, question, gt, seeds_paths, add_spo_line, add_spo_score):
        ...
        if len(GST_list) > 0:
            ...
            comgstspo = self.complete_GST(spo_file, unionGST_file, gst_can_entities, union_predicates, union_cornerpredicates)
